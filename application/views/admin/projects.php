                                    ...
                                    <table id="datatable" class="table table-striped table-bordered table-hover">
                                        ...
                                        foreach($project as $event){
                                            ...
                                            <tr class="even pointer">
                                                ...
                                                <td class=" last">
                                                    <div class="btn-group">
                                                        <a data-toggle="modal" data-target="#more_details<?php echo $event['project_id'];?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Edit</a>
                                                        <a data-toggle="modal" data-target="#delete_project<?php echo $event['project_id'];?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <!--Update modal-->
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="<?php echo site_url('Admin_cont/update_project/'.$event['project_id']);?>">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 col-xs-12">
                                                                        <button type="submit" name="updateproject_btn" class="btn btn-success btn-sm"><i class="fa fa-trash"></i> Update Project</button>
                                            ...
                                            <!--Delete modal-->
                                            <div class="modal" id="delete_project<?php echo $event['project_id'];?>">
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="<?php echo site_url('Admin_cont/deleteproject/'.$event['project_id']);?>">
                                                                <div class="row">
                                                                    <div class="col-md-12 col-xs-12">
                                                                        <button type="submit" name="deleteproject_btn" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete Project</button>
                                                                        <button type="button" class="btn btn-warning btn-sm" data-dismiss="modal"><i class="fa fa-remove"></i> Cancel</button>
                                                                    </div>
                                                                </div>
                                                            </form>
