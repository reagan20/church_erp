...
/*elseif($this->session->userdata('isloggedin') && $this->session->userdata('role')=='Member'){
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/searchable_form/select2.css" />
...
<div id="navbar" class="navbar navbar-default          ace-save-state">
    <div class="navbar-container ace-save-state" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            <a href="<?php echo site_url('Admin_cont/index');?>" class="navbar-brand">
                <small>
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        ...
                        <span class="user-info">
                            <small>Welcome,</small><?php echo $fname.' '.$lname;?>
                        </span>
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="<?php echo site_url('Admin_cont/personal_details');?>">
                                <i class="ace-icon fa fa-user"></i>
                                Account Details
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Admin_cont/update_password');?>">
