jQuery(function () {
    ...
    function initSelect2() {
        $("#personSelect").select2(),$("#student").select2(),$("#year").select2(),$("#form1").select2(),$("#refresh").select2(),$("#staff").select2(), $("#form").select2(), $("#multiSelect").select2(), $("#templatingSelect").select2({
    ...
    function initTextEditor() {
        $("#textEditorDemo").summernote({height: 300})
    }
    ...
    function initDatepicker() {
        $("#datepickerDemo").datepicker({autoclose: !0}), $("#datepickerDemo1").datepicker({todayHighlight: !0})
    }
